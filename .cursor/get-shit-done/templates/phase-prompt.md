...
<!-- For checkpoint task examples and patterns, see @C:/Projects/studypilot-v2/.cursor/get-shit-done/references/checkpoints.md -->
...
See `C:/Projects/studypilot-v2/.cursor/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `C:/Projects/studypilot-v2/.cursor/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `C:/Projects/studypilot-v2/.cursor/get-shit-done/workflows/verify-phase.md` for verification logic.
