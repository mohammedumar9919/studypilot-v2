...
```bash
INIT=$(node "C:/Projects/studypilot-v2/.cursor/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @C:/Projects/studypilot-v2/.cursor/get-shit-done/templates/spec.md.
