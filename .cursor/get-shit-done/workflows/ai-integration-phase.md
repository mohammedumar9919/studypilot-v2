...
<required_reading>
@C:/Projects/studypilot-v2/.cursor/get-shit-done/references/ai-frameworks.md
@C:/Projects/studypilot-v2/.cursor/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read C:/Projects/studypilot-v2/.cursor/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "C:/Projects/studypilot-v2/.cursor/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read C:/Projects/studypilot-v2/.cursor/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read C:/Projects/studypilot-v2/.cursor/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read C:/Projects/studypilot-v2/.cursor/agents/gsd-eval-planner.md for instructions.
