...
- **Global scope**: `C:/Projects/studypilot-v2/.cursor/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `C:/Projects/studypilot-v2/.cursor/notes/`)
...
2. Glob `C:/Projects/studypilot-v2/.cursor/notes/*.md` (if directory exists) — global notes
...
Global (C:/Projects/studypilot-v2/.cursor/notes/):
...
2. **No `.planning/`**: Falls back to global `C:/Projects/studypilot-v2/.cursor/notes/` — works in any directory
