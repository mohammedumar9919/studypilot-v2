...
<template>
@C:/Projects/studypilot-v2/.cursor/get-shit-done/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@C:/Projects/studypilot-v2/.cursor/get-shit-done/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `C:/Projects/studypilot-v2/.cursor/get-shit-done/workflows/transition.md`.
...
- Follow @C:/Projects/studypilot-v2/.cursor/get-shit-done/workflows/diagnose-issues.md
