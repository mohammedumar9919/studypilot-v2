...
```markdown
Read C:/Projects/studypilot-v2/.cursor/agents/gsd-ui-researcher.md for instructions.
...
Template: C:/Projects/studypilot-v2/.cursor/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read C:/Projects/studypilot-v2/.cursor/agents/gsd-ui-checker.md for instructions.
