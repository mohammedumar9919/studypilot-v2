...
INSTALL_JS_GLOBAL="C:/Projects/studypilot-v2/.cursor/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node C:/Projects/studypilot-v2/.cursor/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
