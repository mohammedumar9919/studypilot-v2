...
```bash
INIT=$(node "C:/Projects/studypilot-v2/.cursor/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "C:/Projects/studypilot-v2/.cursor/get-shit-done/bin/gsd-tools.cjs" commit \
