...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `C:/Projects/studypilot-v2/.cursor/.gsd-surface.json`
(sibling to `C:/Projects/studypilot-v2/.cursor/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `C:/Projects/studypilot-v2/.cursor/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`C:/Projects/studypilot-v2/.cursor/skills`).
...
`C:/Projects/studypilot-v2/.cursor/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `C:/Projects/studypilot-v2/.cursor/.gsd-surface.json`).
...
<execution_context>
Surface state file: `C:/Projects/studypilot-v2/.cursor/.gsd-surface.json`
Install profile marker: `C:/Projects/studypilot-v2/.cursor/.gsd-profile`
Skill dirs: `C:/Projects/studypilot-v2/.cursor/skills/gsd-*/`
Engine module: `C:/Projects/studypilot-v2/.cursor/get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `C:/Projects/studypilot-v2/.cursor/get-shit-done/bin/lib/clusters.cjs`
</execution_context>
